        ...
        <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
            ...
            <ul class="nav navbar-toolbar">
                ...
                @if(Auth::user()->is('admin') or Auth::user()->is('root'))
                    <li class="hidden-float">
                        <a class="icon" href="{{ url('/siswa/score') }}" role="button">
                            Nilai
                        </a>
                    </li>
                    <li class="hidden-float">
                        <a class="icon" href="{{ url('/siswa/achievement') }}" role="button">
                            Prestasi
                        </a>
                    </li>
                    <li class="hidden-float">
                        <a class="icon" href="{{ url('/siswa/attendance') }}" role="button">
                            Absen
                        </a>
                    </li>
                @endif
                ...
                @if(Auth::user()->is('pembina') or Auth::user()->is('root'))
                    <li class="hidden-float">
                        <a class="icon" href="{{ url('/siswa/language/score') }}" role="button">
                            Nilai Bahasa
                        </a>
                    </li>
                    <li class="hidden-float">
                        <a class="icon" href="{{ url('/siswa/student-ekskul') }}" role="button">
                            Nilai Ekskul
                        </a>
                    </li>
                    <li class="hidden-float">
                        <a class="icon" href="{{ url('/siswa/violation') }}" role="button">
                            Pelanggaran
                        </a>
                    </li>
                ...
                @if(Auth::user()->is('alquran') or Auth::user()->is('root'))
                    <li class="hidden-float">
                        <a class="icon" href="{{ url('/siswa/reading') }}" role="button">
                            Bacaan
                        </a>
                    </li>
                    <li class="hidden-float">
                        <a class="icon" href="{{ url('/siswa/recitation') }}" role="button">
                            Hafalan
                        </a>
                    </li>
                @endif
            ...
            <form role="search">
                <div class="form-group">
                    <div class="input-search">
                        ...
                        <input type="text" class="form-control" id="searchStudent" name="site-search" placeholder="Search...">
